...
{
    public class Lyrics3 : StoryboardObjectGenerator
    {
        [Configurable]
        ...
        [Configurable]
        public string SpritesPath = "sb/uD";
        ...
        public void generatePerLine(FontGenerator font, SubtitleSet subtitles, StoryboardLayer layer, bool additive)
        {
            foreach (var line in subtitles.Lines)
            {
                ...
                var position = new Vector2(320 - texture.BaseWidth * FontScale * 0.5f + 275, SubtitleY)
                ...
                sprite.Fade(line.StartTime, line.StartTime + 200, 0, 1);
                sprite.Fade(line.EndTime - 200, line.EndTime, 1, 0);
                sprite.Rotate(line.StartTime, Math.PI);

                if(second){

                    sprite.MoveY(line.StartTime, 100);
                    sprite.MoveX(line.StartTime, 240);

                }else{
                    sprite.MoveY(OsbEasing.OutElastic,line.StartTime, line.StartTime + 200, 215, 235);
                }
